<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    headerFilter: {
     ...
     onExporting(e) {
       ...
       const worksheet = workbook.addWorksheet('Righe fattura');
       ...
       DevExpress.excelExporter.exportDataGrid({
         ...
         saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'RicheFattura.xlsx');
         });
      });
      e.cancel = true;
     },
      ...
      cellTemplate(container, options) {
                                       const link = $("<a>");
                                       link.attr("href", '${pageContext.request.contextPath}/tables/invoiceitem/read.jsp?id=' + options.value)
