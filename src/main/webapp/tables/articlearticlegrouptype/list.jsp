<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <h5>Articolo gruppo articolo</h5>
    ...
    headerFilter: {
     ...
     onExporting(e) {
       ...
       const worksheet = workbook.addWorksheet('ArticoloGruppoArticolo');
       ...
       DevExpress.excelExporter.exportDataGrid({
         ...
         saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'ArticoloGruppoArticolo.xlsx');
         });
      });
      e.cancel = true;
     },
      ...
      cellTemplate(container, options) {
                                       const link = $("<a>");
                                       link.attr("href", '${pageContext.request.contextPath}/tables/articlearticlegrouptype/read.jsp?id=' + options.value)
