<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    headerFilter: {
     ...
     onExporting(e) {
       ...
       const worksheet = workbook.addWorksheet('ArticoloTipoMacchina');
       ...
       DevExpress.excelExporter.exportDataGrid({
         ...
         saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'ArticoloTipoMacchina.xlsx');
         });
      });
      e.cancel = true;
     },
      ...
      cellTemplate(container, options) {
                                       const link = $("<a>");
                                       link.attr("href", '${pageContext.request.contextPath}/tables/articlemachinetype/read.jsp?id=' + options.value)
